...
parser.add_argument("--sample_path", default=r"E:\AI_Lab\lab17_com\TMM\ckpts\samples")

parser.add_argument("--data_path", default=r"E:\data\video coding")
...
parser.add_argument("--output_dir", type=str,default=r'E:\AI_Lab\lab17_com\TMM\ckpts\results')
...
parser.add_argument("--ckpt", type=str, default=r'E:\AI_Lab\lab17_com\TMM\ckpts\sample45_0.pth')
